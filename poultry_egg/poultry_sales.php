    ...
    <aside
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item ">
                    <a class="nav-link text-white active" href="poultry_sales.php">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                                        ...
                                        <div class="col-lg-12 col-md-12">
                                            <div class="table-responsive" id="containerSalesTable">
                                                <table class="table table-bordered" id="tblSales" style="width:100%">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        $sql = "SELECT * FROM `tbl_orders` LEFT JOIN tbl_products ON tbl_orders.O_ProductID = tbl_products.P_ID WHERE O_Seller='$user' AND O_Status = 'Pending'";
                                                        $result = $db->query($sql);
                                                        while ($row = $result->fetch_assoc()) {
                                                            ?>
                                                            <tr>
                                                                <td>
                                                                    <?php echo $row['O_Customer'] ?>
                                                                </td>
                                                                <td>
                                                                    <?php echo $row['P_Type'] ?>
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <button class="btn btn-success btn-sm"
                                                                        onclick="completeOrder(<?php echo $row['O_ID'] ?>)">Complete</button>
                                                                    <button class="btn btn-danger btn-sm"
                                                                        onclick="declineOrder(<?php echo $row['O_ID'] ?>)">Decline</button>
                                                                </td>
                                                            </tr>
                                                        <?php } ?>
                                                    </tbody>
    ...
    <script>
        ...
        function completeOrder($___d) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "assets/php/confirm_order.php",
                        type: "POST",
                        data: {
                            oid: $___d,
                        },
        ...
        function declineOrder($___d) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "assets/php/decline_order.php",
                        type: "POST",
                        data: {
                            oid: $___d,
                        },
